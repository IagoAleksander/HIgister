...
//        int color= ContextCompat.getColor(context,forward?R.color.color_logo_sign_up:R.color.color_logo_log_in);
        if (sharedElements.get(0).getDrawable() != null)
            DrawableCompat.setTint(sharedElements.get(0).getDrawable(), ContextCompat.getColor(context, R.color.white_transparent));

...
//    {
//        return "ClassPojo [status_code = "+status_code+", limit = "+limit+", results = "+results+", error = "+error+", number_of_total_results = "+number_of_total_results+", offset = "+offset+", number_of_page_results = "+number_of_page_results+", version = "+version+"]";
//    }
}